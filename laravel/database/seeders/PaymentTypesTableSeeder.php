...
class PaymentTypesTableSeeder extends Seeder
{
    ...
    static public $paymentTypes = [
        ['code' => 'VCARD', 'name' => 'vCard', 'description' => 'vCard phone number', 'deleted' => false, 'debit_weight' => 100, 'credit_weight' => 100, 'validation_rules' => '{"1": "required","2": "digits:9","3": "starts_with:9","4": "exists:Vcards,phone_number"}'],
        ['code' => 'PAYPAL', 'name' => 'PayPal', 'description' => 'PayPal email account', 'deleted' => false, 'debit_weight' => 50, 'credit_weight' => 50, 'validation_rules' => '{"1": "required","2": "email"}'],
        ['code' => 'MBWAY', 'name' => 'MB WAY', 'description' => 'MB WAY phone number', 'deleted' => false, 'debit_weight' => 50, 'credit_weight' => 100, 'validation_rules' => '{"1": "required","2": "digits:9","3": "starts_with:9"}'],
        ['code' => 'IBAN', 'name' => 'Bank Transfer', 'description' => 'Bank Transfer - IBAN account code (2 letters and 23 digits)', 'deleted' => false, 'debit_weight' => 100, 'credit_weight' => 400, 'validation_rules' => '{"1": "required","2": "regex:/(^[A-Z]{2}(?:[ ]?[0-9]){18,20}$)/u"}'],
        ['code' => 'MB', 'name' => 'Multibanco', 'description' => 'Multibanco payment - Entity (5 digits) + Reference (9 digits)', 'deleted' => false, 'debit_weight' => 400, 'credit_weight' => 0, 'validation_rules' => '{"1": "required","2": "regex:/(^[0-9]{5} ([0-9]{9})?$)/u"}'],
        ['code' => 'VISA', 'name' => 'Visa Card', 'description' => 'Visa Card number', 'deleted' => false, 'debit_weight' => 100, 'credit_weight' => 20, 'validation_rules' => '{"1": "required","2": "regex:/(^4[0-9]{12}(?:[0-9]{3})?$)/u"}'],
        ['code' => 'MASTERCARD', 'name' => 'Mastercard', 'description' => 'Mastercard number', 'deleted' => true, 'debit_weight' => 50, 'credit_weight' => 20, 'validation_rules' => '{"1": "required","2": "regex:/(^(5[1-5][0-9]{14}|2(22[1-9][0-9]{12}|2[3-9][0-9]{13}|[3-6][0-9]{14}|7[0-1][0-9]{13}|720[0-9]{12}))$)/u"}'],
    ];
